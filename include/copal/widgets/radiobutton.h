...
#define CL_RADIOBUTTON_DESC_INIT { CL_RADIOBUTTON_DESC_INIT_FIELDS }
...
/** cl_radiobutton_text() - borrowed label (UTF-8) or NULL; valid until set_text. */
CL_API const char *cl_radiobutton_text(cl_widget_t *rb);
